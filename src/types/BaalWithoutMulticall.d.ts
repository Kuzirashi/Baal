...
interface BaalWithoutMulticallInterface extends ethers.utils.Interface {
  functions: {
...
export class BaalWithoutMulticall extends Contract {
  ...
  interface: BaalWithoutMulticallInterface;
